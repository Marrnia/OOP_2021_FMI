#ifndef EARTHCARD_HPP
#define EARTHCARD_HPP
...
public:
    EarthCard()
    {
        ...
        this->power = 0;
        this->bonus_power = 0;
        this->card_type = EARTH;
    }

    EarthCard(const my::string& card_name, const unsigned& power = 0, const unsigned& bonus_power = 0)
    {
    ...
    EarthCard& operator=(const EarthCard& rhs) {
        card_name = rhs.card_name;
        power = rhs.power;
    ...
    friend std::ostream& operator<<(std::ostream& out, const EarthCard& object) {
    ...
    friend std::istream& operator>>(std::istream& in, EarthCard& object) {
        std::cout << "Name:";
        in >> object.card_name;
        std::cout << "Power:";
        in >> object.power;
